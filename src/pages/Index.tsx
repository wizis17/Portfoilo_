    ...
    <Layout>
      ...
      <section className="py-24 bg-secondary/50">
        <div className="container mx-auto px-4">
          ...
          >
            <Link
              to="/about"
              className="inline-flex items-center px-6 py-3 bg-brand-purple text-white rounded-lg font-medium hover:bg-opacity-90 transition-all"
            >
              More About Me
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredProjects.map((project, index) => (
              ...
              >
                <div className="h-40 bg-gradient-to-br from-brand-purple/30 to-blue-500/30" />
                <div className="p-6">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex items-center justify-center w-16 h-16 bg-brand-purple/10 rounded-full mb-6 mx-auto">
            ...
            <Link
              to="/contact"
              className="inline-flex items-center px-8 py-4 bg-brand-purple text-white rounded-lg font-medium hover:bg-opacity-90 transition-all"
            >
              Get in Touch
              <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
